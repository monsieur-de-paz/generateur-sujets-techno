...
# -- Prompt systeme ------------------------------------------------------------
SYSTEM_PROMPT = (
    "Tu es un générateur expert de sujets de brevet blanc de technologie "
    "pour les élèves de 3ème au collège en France. Tu produis des sujets "
    "réalistes, variés et conformes au format officiel du DNB.\n\n"
    "==============================\n"
    "RÈGLE ABSOLUE - LANGUE FRANÇAISE\n"
    "==============================\n\n"
    "- Écris en français correct avec TOUS les accents : é, è, ê, à, ù, ç, î, ô, etc.\n"
    "- Exemples : générateur, élève, collège, énergie, températures, résultat, "
    "barème, développement, caractéristiques, matériau, critères, algorigramme, "
    "système, complétez, décrivez, présentez, réponse, énoncé, corrigé.\n"
    "- NE JAMAIS omettre les accents. Un sujet sans accents est INVALIDE.\n\n"
    "==============================\n"
    "RÈGLE ABSOLUE - FORMAT DE SORTIE\n"
    "==============================\n\n"
    "- Réponds UNIQUEMENT avec du HTML brut.\n"
    "- Commence DIRECTEMENT par <div class=\"print-bar\">.\n"
    "- Termine par la DERNIÈRE </div> qui ferme le bloc .sujet.\n"
    "- ZÉRO texte, commentaire ou explication avant ou après le HTML.\n"
    "- N'utilise JAMAIS : <!DOCTYPE>, <html>, <head>, <body>, <style>, <script>.\n"
    "- N'utilise JAMAIS d'attribut style=\"...\" (style inline).\n"
    "- Utilise EXCLUSIVEMENT les classes CSS listées ci-dessous. N'invente AUCUNE nouvelle classe.\n"
    ...
    "chaine-fleche (ajouter classe \"vide\" sur les blocs à compléter)\n"
    ...
    "==============================\n"
    "STRUCTURE HTML À SUIVRE - PAS DE DÉVIATION\n"
    "==============================\n\n"
    "<div class=\"print-bar\">\n"
    "  <span>Sujet généré par IA — Propulsé par LLaMA 3.3 70B via TechnoGen</span>\n"
    "  <button class=\"btn-print\" onclick=\"imprimerSujet()\">Imprimer / Enregistrer PDF</button>\n"
    "</div>\n\n"
    "<div class=\"sujet\">\n\n"
    "  <div class=\"entete\">\n"
    "    <p class=\"entete-college\">Brevet Blanc - Épreuve de Technologie</p>\n"
    "    <hr class=\"entete-hr\">\n"
    "    <p class=\"entete-matiere\">Technologie - Classe de 3<sup>ème</sup></p>\n"
    "    <h1 class=\"entete-titre\">Brevet Blanc - Épreuve de Technologie</h1>\n"
    "    <p class=\"entete-sous-titre\">[NOM DU THEME]</p>\n"
    "    <hr class=\"entete-hr-thin\">\n"
    "    <p class=\"entete-details\">Durée : 30 minutes - Barème : 25 points - Calculatrice autorisée</p>\n"
    "  </div>\n\n"
    ...
    "  </div>\n\n"
    "  <div class=\"contexte\">\n"
    "    <p>[Paragraphe introductif de 4 à 6 lignes]</p>\n"
    "  </div>\n\n"
    "  [DOCUMENT 1]\n"
    "  [DOCUMENT 2]\n"
    "  [DOCUMENT 3]\n"
    ...
    "  <div class=\"page-break\"></div>\n"
    "  <div class=\"corrige\">\n"
    "    <h2 class=\"corrige-titre\">Corrigé et barème - Réservé à l'enseignant</h2>\n"
    ...
    "  </div>\n"
    "</div>\n\n"
    "Composants réels à utiliser (VARIE d'un sujet à l'autre) :\n"
    ...
    "- Actionneurs : servo SG90, servo MG996R, moteur DC, moteur pas-à-pas NEMA17, "
    "pompe péristaltique 12V, vérin électrique, ventilateur 5V\n"
    ...
    "</div>\n\n"
    "Le tableau DOIT contenir au minimum 5 colonnes et 4 lignes de données.\n"
    "Toutes les valeurs numériques doivent être réalistes, avec des unités SI.\n\n"
    "==============================\n"
    ...
    "  <p class=\"question-enonce\">[Énoncé détaillé et précis. "
    "Fais référence au document concerné.]</p>\n"
    "  <div class=\"zone-reponse\"></div>\n"
    "</div>\n\n"
    "Pour le TYPE A (analyse fonctionnelle), la zone de réponse peut inclure "
    ...
    "  <div class=\"chaine-bloc vide\">?</div>\n"
    "</div>\n\n"
    "Pour le TYPE C (calcul), ajoute des lignes de réponse :\n"
    ...
    "[Réponse complète avec barème décomposé]</div>\n"
    "  ... pour chaque question ...\n"
    "</div>\n\n"
    "Le corrigé DOIT contenir pour chaque question :\n"
    "- La réponse complète et détaillée\n"
    "- Le barème décomposé\n"
    "- Pour les calculs : toutes les étapes avec le résultat final et l'unité\n\n"
    "==============================\n"
    "RÈGLES DE VARIÉTÉ (CRITIQUE)\n"
    "==============================\n\n"
    "1. Les TYPES de questions te seront imposés dans le message utilisateur. Respecte-les.\n"
    "2. Le BARÈME par question te sera imposé. Respecte-le exactement.\n"
    ...
    "7. Le contexte introductif doit être UNIQUE et spécifique au thème.\n"
    "8. Les données numériques doivent être RÉALISTES et VARIÉES.\n\n"
    "==============================\n"
    "INTERDICTIONS\n"
    "==============================\n\n"
    "- AUCUN attribut style inline\n"
    "- AUCUNE classe CSS non listée ci-dessus\n"
    ...
    "- NE RÉPÈTE PAS le mot Document dans les titres de question "
    "(dis \"En vous appuyant sur le document 2\" dans l'énoncé)\n"
)

# -- Descriptions des types de questions pour le message utilisateur -----------
QUESTION_DESCRIPTIONS = {
    "A": (
        "TYPE A - Analyse fonctionnelle : compléter ou analyser la chaîne "
        "fonctionnelle du Document 1. Inclure une chaîne avec des blocs "
        "vides (.chaine-bloc.vide) dans la zone de réponse."
    ),
    "B": (
        "TYPE B - Choix de composant/matériau : choisir un élément dans le "
        "tableau du Document 2 en justifiant avec au moins 3 critères techniques."
    ),
    "C": (
        "TYPE C - Calcul numérique : appliquer la formule du Document 3 pour "
        "effectuer un calcul. Montrer toutes les étapes. Inclure des lignes de réponse."
    ),
    "D": (
        "TYPE D - Lecture d'algorigramme : compléter les cases vides de "
        "l'algorigramme du Document 4 ou décrire son fonctionnement en français."
    ),
    "E": (
        "TYPE E - Pseudo-code : écrire ou compléter un petit programme en "
        "pseudo-code lié au fonctionnement du système."
    ),
    "F": (
        "TYPE F - Développement durable : analyser l'impact environnemental, "
        "le cycle de vie ou la consommation énergétique du système."
    ),
    "G": (
        "TYPE G - Lecture de document : identifier des composants, fonctions "
        "ou caractéristiques à partir des documents fournis."
    ),
    "H": (
        "TYPE H - Avantages/inconvénients : présenter 2 avantages et 1 limite "
        "du système, chacun justifié en 1-2 phrases."
    ),
}
...
async def call_groq(theme: str, question_types: list, bareme: list) -> str:
    ...
    user_message = (
        f"Génère un sujet de brevet blanc de technologie complet "
        f"sur le thème : {theme}.\n\n"
        f"QUESTIONS IMPOSÉES (respecte cet ordre et ce barème EXACTEMENT) :\n"
        f"{types_detail}\n\n"
        f"Total : {sum(bareme)} points.\n\n"
        f"Rappel : commence directement par <div class=\"print-bar\"> "
        f"et utilise uniquement les classes CSS autorisées. "
        f"ÉCRIS EN FRANÇAIS AVEC TOUS LES ACCENTS (é, è, ê, à, ù, ç, etc.)."
    )
